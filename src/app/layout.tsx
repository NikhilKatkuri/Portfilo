...
export const metadata: Metadata = {
  ...
  description:
    "Portfolio of Nikhil Katkuri, showcasing web development, AI, and software engineering projects.",
  keywords: [
    "Nikhil Katkuri",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://portfilo-livid.vercel.app/og-image.jpg",
        width: 1200,
        height: 630,
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="description"
          content="Full-Stack Developer & AI Engineer skilled in Next.js, React, and Python."
        />
        <meta
          name="keywords"
          content="Full-Stack Developer, AI Engineer, Next.js, React, Python, Web Development"
        />
        <meta name="author" content="Nikhil Katkuri" />
        <meta property="og:title" content="Nikhil Katkuri Portfolio" />
        <meta
          property="og:description"
          content="Check out my portfolio of web & AI projects."
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Explore my portfolio of web development & AI projects."
        />
        <meta
          name="twitter:image"
          content="https://yourportfolio.com/twitter-image.jpg"
        />
      </head>
